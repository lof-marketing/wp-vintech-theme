...
if (!class_exists('Vintech_Main')) { 
    class Vintech_Main extends Vintech_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Vintech_Main();
            }
...
function vintech() {
    return Vintech_Main::getInstance();
}
// Install
vintech(); 

...
$wrap_attrs = [
    'id'               => $html_id,
    'class' => trim('pxl-grid pxl-industries-grid pxl-industries-grid-layout1 pxl-industries-style1 ' . $settings['custom_box']),
...
if( count($posts) <= 0){
    echo '<div class="pxl-no-post-grid">'.esc_html__( 'No Post Found', 'vintech' ). '</div>';
    return;
} ?>

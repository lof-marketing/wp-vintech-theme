...
$sg_service_title = vintech()->get_theme_opt('sg_service_title', 'default');
$sg_service_title_text = vintech()->get_theme_opt('sg_service_title_text');

$sg_portfolio_title = vintech()->get_theme_opt('sg_portfolio_title', 'default');
$sg_portfolio_title_text = vintech()->get_theme_opt('sg_portfolio_title_text'); 

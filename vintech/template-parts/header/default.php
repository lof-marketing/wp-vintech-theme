...
$logo_m = vintech()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
            ...
            <div class="row">
                ...
                <div class="pxl-header-menu">
                    <div class="pxl-header-menu-scroll">
                        ...
                        <?php vintech_header_mobile_search_form(); ?>
                            ...
                            <?php
                                if ( has_nav_menu( 'primary' ) )
                                {
                                    ...
                                    printf(
                                        ...
                                        esc_html__( 'Create New Menu', 'vintech' )
                                    );
                                    ?>
                                <?php }
                            ?>
